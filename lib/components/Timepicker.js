...
var Timepicker = exports.Timepicker = function (_React$Component) {
	...
	_createClass(Timepicker, [{
		...
		value: function getTime() {
			...
			var meridiemAdd = state.meridiem === 'pm' ? 12 : 0;
			var paddedMinute = ('0' + state.minute).slice(-2);
			return {
...
Timepicker.propTypes = {
	...
	onDoneClick: _react.PropTypes.func,
	switchToMinuteOnHourSelect: _react.PropTypes.bool,
	closeOnMinuteSelect: _react.PropTypes.bool,
