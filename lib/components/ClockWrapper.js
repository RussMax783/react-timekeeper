...
ClockWrapper.propTypes = {
	...
	meridiem: _react.PropTypes.string.isRequired,

	changeHour: _react.PropTypes.func.isRequired,
	changeMinute: _react.PropTypes.func.isRequired,
	changeMeridiem: _react.PropTypes.func.isRequired
};
